...
const Header = () => {
    ...
    return (
        <>
            <div className=' md:flex lg:flex justify-around  items-center bg-purple-50 p-4'>
                ...
                <div onClick={() => setOpen(!open)} className='md:hidden absolute md:static -top-0 pt-3'>
                    <span>
                        {
                            open === true ? <XMarkIcon className="h-8 w-10 text-[purple]" /> : <Bars3Icon className="h-8 w-10 text-[purple] " />
                        }
                    </span>
                ...
                <div className='btn md:order-2 order-2 btn-primary flex lg:m-0 mx-44  lg:justify-end border-none hover:bg-purple-700 text-white md:static absolute -top-0 mt-3'>
                    <h1>Star Applying</h1>
